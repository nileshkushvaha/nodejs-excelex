  ...
  SELECT count(*) INTO bad FROM pg_class c
    ...
    WHERE n.nspname = 'public'
      AND c.relname IN ('branches','users','user_branch_memberships','roles',
                        ...
                        'customer_volumetrics','customer_contacts','consignees','shippers','account_groups','lookups','pin_codes','rate_cards','rate_lines','jobs','job_schedules','login_attempts','mail_settings','mail_messages',
